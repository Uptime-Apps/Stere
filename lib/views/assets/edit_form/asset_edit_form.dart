...
import 'asset_edit_form_controller.dart';
import 'asset_edit_form_state.dart';

class AssetEditForm extends ConsumerWidget {
  static const route = 'asset-edit-form';
  const AssetEditForm({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final prov = ref.watch(assetEditFormControllerProvider);
    final notifier = ref.read(assetEditFormControllerProvider.notifier);
  ...
  List<Widget> formStructure(BuildContext context, AssetEditFormState state,
      AssetEditFormController controller) {
    return [
      StereImagePicker(
